-- Corrigir ambiguidade na função generate_contract_installments
...
BEGIN
  ...
  LOOP
    ...
    WHILE current_date_calc <= CURRENT_DATE AND iteration_count < max_iterations LOOP
      ...
      -- Verificar se já atingiu o total de parcelas (qualificar contract_id)
      ...
      INSERT INTO public.transactions (
        ...
        CASE WHEN contract_record.type = 'expense' THEN contract_record.bank_account_id END,
        CASE WHEN contract_record.type = 'income' THEN contract_record.bank_account_id END,
