-- Atualizar função generate_contract_installments para copiar centro_custo_id e categorias
...
BEGIN
  ...
  LOOP
    ...
    WHILE current_date_calc <= CURRENT_DATE AND iteration_count < max_iterations LOOP
      ...
      -- Inserir a transação SEMPRE como RECEITA, copiando centro de custo e categorias
